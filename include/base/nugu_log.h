...
enum nugu_log_module {
	...
	NUGU_LOG_MODULE_APPLICATION = 0x40, /**< Application module */
	NUGU_LOG_MODULE_PRESET_SDK_DEFAULT =
		(NUGU_LOG_MODULE_DEFAULT | NUGU_LOG_MODULE_NETWORK |
		 NUGU_LOG_MODULE_AUDIO | NUGU_LOG_MODULE_PROTOCOL),
	/**< Preset: Default SDK */
	NUGU_LOG_MODULE_PRESET_DEFAULT = (NUGU_LOG_MODULE_PRESET_SDK_DEFAULT |
					  NUGU_LOG_MODULE_APPLICATION),
	/**< Preset: Default SDK with application */
	NUGU_LOG_MODULE_PRESET_NETWORK =
		(NUGU_LOG_MODULE_NETWORK | NUGU_LOG_MODULE_NETWORK_TRACE |
